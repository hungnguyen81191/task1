...
//     if (HOLIDAY_LIST.includes(current_date.toISOString().substring(0,10))) {
...
function takeSchedule(current_date) {
    let i = 0;
    let text = "";
    let next_date;
    let day;
   ...
   do {
      // console.log(1);
        ...
        //console.log(day);
        if (!HOLIDAY_LIST.includes(text) && DAY_STR[day] != "SUN") {
...
console.log(takeSchedule(current));